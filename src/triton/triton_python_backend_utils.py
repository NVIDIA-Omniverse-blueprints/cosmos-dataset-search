...
This file should be baked inside triton server docker images.
However, for unit-testing, we include it also here.
"""
...
class InferenceRequest:
    ...
    def __init__(self, inputs, request_id, correlation_id, requested_output_names):
        self._inputs = inputs
